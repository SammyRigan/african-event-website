      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <div className="max-w-6xl mx-auto">
            ...
            {/* Subtitle */}
            <div className="mb-8">
              <p className="text-xl lg:text-2xl font-bold text-gray-200 mb-4 font-heading">FESTIVAL & FORUM 2025</p>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg leading-relaxed font-medium text-gray-300">
                Discover emerging talents and established brands redefining luxury and sustainability. Engage in
                discussions on ethical production and market access. Witness stunning fashion showcases and connect with
                innovators.
              </p>
              <Button
                variant="outline"
